...
<nav class="navbar navbar-inverse">
	...
	<div class="container" >
		<div class="row">
		<div class="col-sm-2">
				<form:form class="form-horizontal" modelAttribute="filter" action="/admin/material/" method="GET">
			...
			<div class="col-sm-8">
				<form:form class="form-horizontal" modelAttribute="material" action="/admin/material/" method="POST">
					<div class="form-group">
			...
			<div class="col-sm-8">
				<table width="100%" class="table table-bordered">
					...
					<tr>
						...
						<td class="text-center"><a href="/admin/material/update/${material.id}" class="btn btn-warning">Update</a></td>
						<td class="text-center"><a href="/admin/material/delete/${material.id}" class="btn btn-danger">Delete</a></td>
					</tr>
					</c:forEach>
				</table>
			</div>
