...
<nav class="navbar navbar-inverse">
	...
	<h2 class="text-center">Sex</h2>
	<div class="container" >
		<div class="row">
		<div class="col-sm-2">
				<form:form class="form-horizontal" modelAttribute="filter" action="/admin/gender/" method="GET">
			...
			<div class="col-sm-8">
				<form:form class="form-horizontal" modelAttribute="gender" action="/admin/gender/" method="POST">
					<div class="form-group">
		...
		<div class="col-sm-2"></div>
			<div class="col-sm-8">
				<table width="100%" class="table table-bordered table-condensed">
					...
					<c:forEach items="${genders.content}" var="gender">
					<tr>
						<td class="text-center">${gender.name}</td>
						<td class="text-center"><a href="/admin/gender/update/${gender.id}" class="btn btn-warning">Update</a></td>
						<td class="text-center"><a href="/admin/gender/delete/${gender.id}" class="btn btn-danger">Delete</a></td>
					</tr>
					</c:forEach>
				</table>
			</div>
