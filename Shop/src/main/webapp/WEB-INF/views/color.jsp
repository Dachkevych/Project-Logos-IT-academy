...
<nav class="navbar navbar-inverse">
	...
	<div class="container" >
		<div class="row">
		<div class="col-sm-2">
				<form:form class="form-horizontal" modelAttribute="filter" action="/admin/color/" method="GET">
			...
			<div class="col-sm-8">
				<form:form class="form-horizontal" modelAttribute="color" action="/admin/color/" method="POST">
					<div class="form-group">
		...
		<div class="col-sm-2"></div>
			<div class="col-sm-8">
				<table width="100%" class="table table-bordered">
					...
					<c:forEach items="${colors.content}" var="color">
					<tr>
						<td class="text-center">${color.name}</td>
						<td class="text-center"><a href="/admin/color/update/${color.id}" class="btn btn-warning">Update</a></td>
						<td class="text-center"><a href="/admin/color/delete/${color.id}" class="btn btn-danger">Delete</a></td>
					</tr>
					</c:forEach>
				</table>
			</div>
