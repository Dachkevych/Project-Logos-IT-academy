...
<nav class="navbar navbar-inverse">
	...
	<h2 class="text-center">Season</h2>
	<div class="container" >
		<div class="row">
		<div class="col-sm-2">
				<form:form class="form-horizontal" modelAttribute="filter" action="/admin/season/" method="GET">
			...
			<div class="col-sm-8">
				<form:form class="form-horizontal" modelAttribute="season" action="/admin/season/" method="POST">
					<div class="form-group">
		...
		<div class="col-sm-2"></div>
			<div class="col-sm-8">
				<table width="100%" class="table table-bordered">
					...
					<c:forEach items="${seasons.content}" var="season">
					<tr>
						<td class="text-center">${season.name}</td>
						<td class="text-center"><a href="/admin/season/update/${season.id}" class="btn btn-warning">Update</a></td>
						<td class="text-center"><a href="/admin/season/delete/${season.id}" class="btn btn-danger">Delete</a></td>
					</tr>
					</c:forEach>
				</table>
			</div>
